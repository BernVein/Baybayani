        ...
        <div class="w-[50%] bg-white p-6 rounded-lg shadow-md transition-all duration-500 ease-in-out hover:shadow-lg">
          <div v-if="product && product.data">
            ...
            <div class="flex gap-4 mt-8">
              ...
              <button
                class="px-6 py-3 rounded-lg text-green-600 border border-green-600 text-lg font-semibold hover:bg-green-50 transition-transform duration-300 ease-in-out hover:scale-105 flex items-center">
