<template>
  ...
  <footer class="bg-[#0C6539] text-white py-8 mt-10">
    <div
      class="max-w-[1200px] mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8"
    >
      <!-- Footer Section: Company Info -->
      <div>
        <h3 class="text-2xl font-bold mb-4">Baybayani</h3>
        <p class="text-gray-200">
          Your trusted source for local products. We connect you to the best and
          freshest produce from our local community.
        </p>
      </div>
...
// Filter cart items count that are not hidden and not deleted
